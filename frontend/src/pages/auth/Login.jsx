...
import { LuEyeOff, LuLoader, LuEye } from "react-icons/lu";
        ...
        <form className="lg:w-1/2 w-full max-w-lg border border-medical-200 shadow-xl shadow-medical-100 bg-white/95 backdrop-blur-sm rounded-xl py-6 px-9 flex flex-col gap-8"
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className='flex flex-col gap-2 relative'>
              ...
              {showPassword ?
                <LuEyeOff onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-[60%] transform text-medical-400 w-4 h-4 cursor-pointer" />
                :
                <LuEye onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-[60%] transform text-medical-400 w-4 h-4 cursor-pointer" />
              }
            </div>
            {error && (
          ...
          {loading ?
            <span className='w-full flex items-center justify-center py-3 px-4 border border-transparent font-medium rounded-md text-white bg-gradient-to-r from-medical-600 to-emerald-600 hover:from-medical-700 hover:to-emerald-700'>
